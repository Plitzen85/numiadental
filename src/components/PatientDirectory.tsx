...
import { Search, Filter, Plus, UserCircle, Phone, Mail, AlertTriangle } from 'lucide-react';
                ...
                {filteredPatients.map((patient, i) => (
                    ...
                    >
                        <div className="flex justify-between items-start mb-4">
                            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-electric/20 to-premium/20 border-2 border-white/10 flex items-center justify-center text-electric group-hover:border-electric transition-colors">
                                {patient.foto ? (
                                    <img src={patient.foto} alt="Avatar" className="w-full h-full rounded-full object-cover" />
                                ) : (
                        ...
                        <div className="space-y-2 mb-6 flex-1">
                            <div className="flex items-center gap-2 text-sm text-clinical/80">
                                <Phone className="w-4 h-4 opacity-50" /> {patient.telefono}
                            </div>
                            <div className="flex items-center gap-2 text-sm text-clinical/80">
                                <Mail className="w-4 h-4 opacity-50" /> <span className="truncate">{patient.email}</span>
                            </div>
                        </div>
